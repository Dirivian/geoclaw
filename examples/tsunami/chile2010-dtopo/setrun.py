...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times = [0., 0.2, 0.8, 1.2, 100.0]
        #clawdata.output_times = [0., 0.5, 2.0, 100.]
    ...
    rundata.regiondata.regions.append([1,1,0., 1e10, -180,180,-90,90])
    rundata.regiondata.regions.append([3,3,0., 1e10, -79,-78.99,-35.5,-34.5])
...
#-------------------
    ...
    topo_data.topofiles.append([2, 1, 1, 0., 1.e10, 'etopo10min120W60W60S0S.asc'])

    # == setdtopo.data values ==
    dtopo_data = rundata.dtopo_data
    # for moving topography, append lines of the form :   (<= 1 allowed for now!)
    #   [topotype, minlevel,maxlevel,fname]
    dtopo_data.dtopofiles.append([1,1,1,'usgs100227.tt1'])
    ...
    fixedgrids.append([0., 1.4, 11, -92, -72, -35, -35, 500, 1, 0, 0])
